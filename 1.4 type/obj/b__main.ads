...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#80c8d80e#;
   ...
   u00121 : constant Version_32 := 16#ec09f5c7#;
   pragma Export (C, u00121, "calculatorB");
   u00122 : constant Version_32 := 16#6cf0e727#;
   ...
   u00133 : constant Version_32 := 16#8f9a2a55#;
   pragma Export (C, u00133, "case_whenB");
   u00134 : constant Version_32 := 16#133f6f59#;
   pragma Export (C, u00134, "case_whenS");
   u00135 : constant Version_32 := 16#fa5ff436#;
   pragma Export (C, u00135, "fatherB");
   u00136 : constant Version_32 := 16#004177cb#;
   pragma Export (C, u00136, "fatherS");
   u00137 : constant Version_32 := 16#011baf5d#;
   pragma Export (C, u00137, "father__sonB");
   u00138 : constant Version_32 := 16#33595c05#;
   pragma Export (C, u00138, "father__sonS");
   u00139 : constant Version_32 := 16#591b93d1#;
   pragma Export (C, u00139, "ffatherB");
   u00140 : constant Version_32 := 16#4867afaa#;
   pragma Export (C, u00140, "ffatherS");
   u00141 : constant Version_32 := 16#9c15c712#;
   pragma Export (C, u00141, "ffather__ssonB");
   u00142 : constant Version_32 := 16#106922c8#;
   pragma Export (C, u00142, "ffather__ssonS");
   u00143 : constant Version_32 := 16#ae9a24b0#;
   pragma Export (C, u00143, "master_systemB");
   u00144 : constant Version_32 := 16#2a69c7d2#;
   pragma Export (C, u00144, "master_systemS");
   u00145 : constant Version_32 := 16#cc1c4ea5#;
   pragma Export (C, u00145, "master_system__sub_systemB");
   u00146 : constant Version_32 := 16#420642cf#;
   pragma Export (C, u00146, "master_system__sub_systemS");
   u00147 : constant Version_32 := 16#af3aafca#;
   pragma Export (C, u00147, "nestedprocedureB");
   u00148 : constant Version_32 := 16#f55b63ab#;
   pragma Export (C, u00148, "nestedprocedureS");
   u00149 : constant Version_32 := 16#15e3cbe4#;
   pragma Export (C, u00149, "others_testB");
   u00150 : constant Version_32 := 16#25d7ff2b#;
   pragma Export (C, u00150, "others_testS");
   u00151 : constant Version_32 := 16#452f4f0f#;
   pragma Export (C, u00151, "system__img_fixed_32S");
   u00152 : constant Version_32 := 16#3a3869b5#;
   pragma Export (C, u00152, "system__arith_32B");
   u00153 : constant Version_32 := 16#af9af9ed#;
   pragma Export (C, u00153, "system__arith_32S");
   u00154 : constant Version_32 := 16#9448e622#;
   pragma Export (C, u00154, "system__exn_intS");
   ...
   --  ffather%b
   --  master_system%s
   --  master_system.sub_system%s
   --  master_system.sub_system%b
   --  master_system%b
   --  nestedprocedure%s
   --  nestedprocedure%b
   --  others_test%s
